...
class Flux2KleinImageEdit:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "inputcount": (["1","2","3",], {"default": "1", "tooltip": "图像输入数量", "display_name": "图像输入数量"}),
                ...
                "image_1": ("IMAGE", {"tooltip": "image_1", "display_name": "image_1"}),
            },
            "optional": {},
            "hidden": {
                "unique_id": "UNIQUE_ID",
    ...
    DESCRIPTION = "Flux2 Klein 图像编辑 - 动态增减图像输入（1-3张）"
